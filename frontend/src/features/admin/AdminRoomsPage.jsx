...
import { Plus, Pencil, Trash2, ToggleLeft, ToggleRight, BedDouble, Upload, Link as LinkIcon } from 'lucide-react'
...
const emptyRoom = { name: '', type: 'classic', price: '', capacity: 2, size: '', floor: 1, description: '', image: '', available: true }
          ...
          <Card key={room.id} className="overflow-hidden">
            <div className="relative h-40">
              ...
              <div className="absolute top-3 right-3">
                <span className={`px-2 py-1 rounded-full text-xs font-semibold ${room.available ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
            ...
            <div className="p-4">
              ...
              <div className="flex gap-2">
                ...
                <Button size="sm" variant="ghost" className="flex-1"
                  ...
                  {room.available ? <ToggleRight size={14} className="text-green-600" /> : <ToggleLeft size={14} />}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="col-span-2 flex items-center gap-2">
            <input type="checkbox" id="available" checked={form.available}
              onChange={e => setForm(f => ({ ...f, available: e.target.checked }))} className="accent-primary-600" />
